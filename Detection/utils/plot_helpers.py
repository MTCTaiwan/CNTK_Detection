    ...
    for iter in range(0,3):
        for roiIndex in range(len(roi_coords)):
            ...
            if roi_scores is not None:
                ...
                if label != 5 and decision_threshold and score < decision_threshold:
                    label = 0
            ...
            if iter == 0 and draw_negative_rois:
                ...
                results += [{
                    ...
                    "score": str(round(score, 2)) if roi_scores is not None else ''
                }]
    return result_img, results # plz check initial results before iter loop


# plot_helpers.py: line 133
